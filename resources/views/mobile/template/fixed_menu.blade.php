@if (Auth::user())
    <div class="fixed-footer" bis_skin_checked="1">
        ...
        <a href="/mobile/deposit" data-active="false">
            <img alt="Deposit" height="25" loading="lazy"
                ...
                width="25">Depo/WD </a>
        <a href="/mobile/contact-us" data-active="true">
...
@else
    <div class="fixed-footer">
        <a href="/" data-active="true">
            <img alt="Home" height="25" loading="lazy"
                src="http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/home.svg?v=20250528"
                style="--image-src: url(http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/home-active.svg?v=20250528);"
                width="25" />
            Beranda
        </a>
        <a href="promotion.html" data-active="false">
            <img alt="Promotion" height="25" loading="lazy"
                src="http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/promotion.svg?v=20250528"
                style="--image-src: url(http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/promotion-active.svg?v=20250528);"
                width="25" />
            Promosi
        </a>
        <a data-require-login="/mobile/deposit" data-active="false">
            <img alt="Masuk" height="25" loading="lazy"
                src="http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/login.svg?v=20250528"
                style="--image-src: url(http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/login-active.svg?v=20250528);"
                width="25" />Masuk </a>
        <a href="contact-us.html" data-active="false">
            <img alt="Contact Us" height="25" loading="lazy"
                src="http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/live-chat.svg?v=20250528"
                style="--image-src: url(http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/live-chat-active.svg?v=20250528);"
                width="25" />
            Hub. Kami
        </a>
        <a href="https://ligamansion2ksto.site/home/InvalidSession" data-active="false">
            <img alt="My Account" height="25" loading="lazy"
                src="http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/my-account.svg?v=20250528"
                style="--image-src: url(http://dsuown9evwz4y.cloudfront.net/Images/~normad-alpha/dark-gold/mobile/layout/footer/my-account-active.svg?v=20250528);"
                width="25" />
            Akun Saya
        </a>
    </div>

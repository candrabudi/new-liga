...
$(() => {
  window.initializePasswordValidation = () => {
    ...
    const f = () => {
      i.style.display =
        n === document.activeElement || i.classList.contains("error")
          ? ""
          : "none";
    };
    n.focusin = f;
    ...
    if (n) {
      ...
      a &&
        (a.onclick = () => {
          navigator.clipboard &&
            navigator.clipboard
              .writeText(k.value.replaceAll("-", ""))
              .then(() => registerPopup({ content: n.dataset.copiedText }))
              .catch((n) =>
                console.log("Error when copying phone number: " + n)
              );
        });
      ...
      if (t && t.required !== !0) {
        ...
        t.onchange = () => {
          (n.required = !!t.value), (i.required = !!t.value);
        };
      }
      ...
      if (i && i.required !== !0) {
        ...
        i.onchange = () => {
          (n.required = !!i.value), (t.required = !!i.value);
        };
      }
      const y = document.querySelector(".register_message");
      y && registerPopup({ content: y.innerText });
      ...
      if (g) {
        ...
        n.hidden = !0;
        t.hidden = !0;
        const i = document.querySelector("#referral_code_header");
        if (i) {
          const t = document.querySelector("#referral_code_detail_toggler"),
            n = document.querySelector("#referral_code_content");
          i.onclick = () => {
            ...
            n.classList.contains("expand")
              ...
              : (n.classList.add("expand"),
                i.classList.remove("glyphicon-chevron-right"),
        ...
        window.onRegisterAjaxRequestSuccess = (i) => {
          if (
            ((n.hidden = !0),
            (t.hidden = !0),
            registerPopup({ contentTitle: i.statusText, content: i.message }),
            i.status !== !0)
          ) {
      ...
      e &&
        ...
        $(e).rules("add", {
          equalTo: "#FullName",
          messages: { equalTo: e.dataset.valEqualTo },
        });
      ...
      s &&
        ...
        $(s).rules("add", {
          equalTo: "#FullName",
          messages: { equalTo: s.dataset.valEqualTo },
        });
    }
  };
});
$(() => {
  ...
  if (n) {
    ...
    n.onclick = (r) => {
      ...
      if ((t.classList.remove("input-validation-error"), u.length === 0)) {
      ...
      window.$.ajax({
        ...
        data: JSON.stringify({ username: u, channelType: i.value }),
